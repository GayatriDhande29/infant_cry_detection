...
# Main runner
def main():
    audio_file = "/content/drive/MyDrive/babies/test/sample4.wav"     # 🔁 Replace this
    model_path = "/content/drive/MyDrive/babies/models/best_model_pretrain_model.pth"     # 🔁 Replace this with full path to your .pth file
